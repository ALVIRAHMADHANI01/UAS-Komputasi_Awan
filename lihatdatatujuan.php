...
<div id="main">
	<div class="content">
		...
		<button class="print" onclick="PrintDoc()"><img src="http://localhost/pesawat/img/print.png">Print Data</button>
		<button class="print" onclick="PrintPreview()"><img src="http://localhost/pesawat/img/preview.png">Print Preview</button>
